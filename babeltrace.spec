...
Source0  : https://www.efficios.com/files/babeltrace/babeltrace2-2.0.4.tar.bz2
Source1  : https://www.efficios.com/files/babeltrace/babeltrace2-2.0.4.tar.bz2.asc
...
%prep
%setup -q -n babeltrace2-2.0.4
cd %{_builddir}/babeltrace2-2.0.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672165175
